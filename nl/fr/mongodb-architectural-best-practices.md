...
[Présentation de MongoStat![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](http://docs.mongodb.org/manual/reference/mongostat/){: new_window}

[Service de surveillance {{site.data.keyword.mongodb}} de 10gen ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](http://www.10gen.com/products/mongodb-monitoring-service){: new_window}
...
* La commande `mongostat` fournit également des informations d'exécution relatives aux performances d'un noeud {{site.data.keyword.mongodb}}.
...
* Index -  Créez des index pour un déploiement {{site.data.keyword.mongodb}} si les outils de surveillance signalent que des demandes basées sur des zones affichent de médiocres performances. Pour améliorer les performances, utilisez toujours des index lorsque vous demandez des données basées sur des zones distinctes.
