...
`mytop`, a Linux application, is a near-time monitor (similar to the UNIX utility `top`) that monitors the {{site.data.keyword.mysql}} server. `mytop` updates every few seconds to give you a reasonable look at your SQL performance.
